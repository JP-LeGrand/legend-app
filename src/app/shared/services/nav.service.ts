...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		{ path: '/', title: 'home', type: 'link', active: true },
		{ path: '/pages/aboutus', title: 'about-us', type: 'link', active: true },
		{
			title: 'Shop', type: 'sub', active: false, children: [
				{ path: '/shop/collection/left/sidebar', title: 'Women\'s Fragrance', type: 'link', param: 'Women' },
				{ path: '/shop/collection/left/sidebar', title: 'Men\'s Fragrances', type: 'link', param: 'Men' },
				{ path: '/shop/collection/left/sidebar', title: 'Unisex', type: 'link', param: 'Unisex' },
				// { path: '/shop/collection/infinitescroll', title: 'Infinite Scroll', type: 'link' }
			]
		},
		{ path: '/pages/faq', title: 'faq\'s', type: 'link' },
